...
const FlagsLevel = {
  ...
  _bank: [
    ...
    { flag:'🇮🇹', correct:'Italia',           tier:1, distractors:['España','Francia','Irlanda','Portugal'] },
    ...
    { flag:'🇯🇵', correct:'Japón',            tier:1, distractors:['China','Corea del Sur','Bangladés','Georgia'] },
    { flag:'🇨🇳', correct:'China',            tier:1, distractors:['Vietnam','Singapur','Turquía','Marruecos'] },
    { flag:'🇦🇷', correct:'Argentina',        tier:1, distractors:['Uruguay','Paraguay','Bolivia','Chile'] },
    { flag:'🇵🇹', correct:'Portugal',         tier:1, distractors:['España','Brasil','Italia','Argelia'] },
    { flag:'🇮🇪', correct:'Irlanda',          tier:1, distractors:['Italia','Costa de Marfil','Nigeria','México'] },
    { flag:'🇨🇱', correct:'Chile',            tier:1, distractors:['Cuba','Puerto Rico','Uruguay','Argentina'] },
    { flag:'🇵🇪', correct:'Perú',             tier:1, distractors:['Canadá','Austria','Polonia','Dinamarca'] },
    { flag:'🇨🇺', correct:'Cuba',             tier:1, distractors:['Chile','Puerto Rico','Liberia','Malasia'] },
    { flag:'🇪🇬', correct:'Egipto',           tier:1, distractors:['Siria','Irak','Libia','Yemen'] },
    { flag:'🇸🇦', correct:'Arabia Saudí',     tier:1, distractors:['Pakistán','Irán','Argelia','Libia'] },
    { flag:'🇮🇩', correct:'Indonesia',        tier:1, distractors:['Mónaco','Polonia','Singapur','Dinamarca'] },
    { flag:'🇺🇾', correct:'Uruguay',          tier:1, distractors:['Argentina','Paraguay','Bolivia','Ecuador'] },
    // ── Tier 2: nivel medio ───────────────────────────────────────
    { flag:'🇦🇺', correct:'Australia',        tier:2, distractors:['Nueva Zelanda','Fiji','Tuvalu','Reino Unido'] },
    { flag:'🇨🇦', correct:'Canadá',           tier:2, distractors:['Estados Unidos','Perú','Dinamarca','Suiza'] },
    ...
    { flag:'🇩🇰', correct:'Dinamarca',        tier:2, distractors:['Suiza','Suecia','Noruega','Georgia'] },
    { flag:'🇫🇮', correct:'Finlandia',        tier:2, distractors:['Suecia','Estonia','Islandia','Grecia'] },
    { flag:'🇦🇹', correct:'Austria',          tier:2, distractors:['Letonia','Polonia','Perú','Singapur'] },
    { flag:'🇳🇿', correct:'Nueva Zelanda',    tier:2, distractors:['Australia','Tuvalu','Samoa','Fiyi'] },
    { flag:'🇻🇳', correct:'Vietnam',          tier:2, distractors:['China','Marruecos','Angola','Turquía'] },
    { flag:'🇲🇦', correct:'Marruecos',        tier:2, distractors:['Turquía','Filipinas','Arabia Saudí','Argelia'] },
    { flag:'🇹🇭', correct:'Tailandia',        tier:2, distractors:['Costa Rica','Croacia','Luxemburgo','Países Bajos'] },
    { flag:'🇵🇭', correct:'Filipinas',        tier:2, distractors:['Cuba','Chile','Puerto Rico','Liberia'] },
    { flag:'🇵🇰', correct:'Pakistán',         tier:2, distractors:['Arabia Saudí','Argelia','Turquía','Azerbaiyán'] },
    { flag:'🇳🇬', correct:'Nigeria',          tier:2, distractors:['Irlanda','Costa de Marfil','Jamaica','Kenia'] },
    { flag:'🇪🇨', correct:'Ecuador',          tier:2, distractors:['Colombia','Venezuela','Bolivia','Ghana'] },
    { flag:'🇻🇪', correct:'Venezuela',        tier:2, distractors:['Colombia','Ecuador','Bolivia','Camerún'] },
    { flag:'🇧🇴', correct:'Bolivia',          tier:2, distractors:['Etiopía','Ghana','Guinea','Camerún'] },
    { flag:'🇰🇪', correct:'Kenia',            tier:2, distractors:['Nigeria','Ghana','Zimbabwe','Sudáfrica'] },
    { flag:'🇮🇱', correct:'Israel',           tier:2, distractors:['Grecia','Finlandia','Estonia','Argentina'] },
    { flag:'🇲🇾', correct:'Malasia',          tier:2, distractors:['Liberia','Filipinas','Cuba','Costa Rica'] },
    // ── Tier 3: difíciles ─────────────────────────────────────────
    ...
    { flag:'🇬🇷', correct:'Grecia',           tier:3, distractors:['Chipre','Uruguay','Finlandia','El Salvador'] },
    ...
    { flag:'🇭🇺', correct:'Hungría',          tier:3, distractors:['Italia','Bulgaria','Irán','Líbano'] },
    { flag:'🇷🇴', correct:'Rumanía',          tier:3, distractors:['Chad','Andorra','Moldavia','Bélgica'] },
    { flag:'🇸🇰', correct:'Eslovaquia',       tier:3, distractors:['Rusia','Eslovenia','Serbia','Croacia'] },
    { flag:'🇭🇷', correct:'Croacia',          tier:3, distractors:['Eslovenia','Serbia','Eslovaquia','Países Bajos'] },
    { flag:'🇮🇸', correct:'Islandia',         tier:3, distractors:['Noruega','Suecia','Dinamarca','Finlandia'] },
    { flag:'🇪🇪', correct:'Estonia',          tier:3, distractors:['Países Bajos','Ucrania','Kazajistán','Finlandia'] },
    { flag:'🇱🇻', correct:'Letonia',          tier:3, distractors:['Austria','Perú','Lituania','Georgia'] },
    { flag:'🇱🇹', correct:'Lituania',         tier:3, distractors:['Etiopía','Bolivia','Ghana','Bielorrusia'] },
    { flag:'🇷🇸', correct:'Serbia',           tier:3, distractors:['Croacia','Eslovenia','Eslovaquia','Rusia'] },
    { flag:'🇲🇳', correct:'Mongolia',         tier:3, distractors:['Azerbaiyán','Kazajistán','Uzbekistán','Turkmenistán'] },
    { flag:'🇨🇿', correct:'Chequia',          tier:3, distractors:['Eslovaquia','Eslovenia','Serbia','Filipinas'] },
    { flag:'🇬🇭', correct:'Ghana',            tier:3, distractors:['Senegal','Guinea','Camerún','Zimbabue'] },
    { flag:'🇸🇬', correct:'Singapur',         tier:3, distractors:['Corea del Sur','Japón','Bangladés','Turquía'] },
    { flag:'🇧🇩', correct:'Bangladés',        tier:3, distractors:['Japón','Palau','Zimbabue','Portugal'] },
    { flag:'🇰🇿', correct:'Kazajistán',       tier:3, distractors:['Uzbekistán','Mongolia','Azerbaiyán','Turkmenistán'] },
    { flag:'🇵🇾', correct:'Paraguay',         tier:3, distractors:['Uruguay','Bolivia','Argentina','Perú'] },
    { flag:'🇦🇿', correct:'Azerbaiyán',       tier:3, distractors:['Turquía','Uzbekistán','Kazajistán','Kirguistán'] },
    { flag:'🇱🇺', correct:'Luxemburgo',       tier:3, distractors:['Países Bajos','Francia','Croacia','Tailandia'] },
  ],
